...
```
cd existing_repo
git remote add origin https://gitlab.com/investing-portal/backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/investing-portal/backend/-/settings/integrations)
